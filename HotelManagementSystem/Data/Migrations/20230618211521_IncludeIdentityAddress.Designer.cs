...
namespace HotelManagementSystem.Data.Migrations
{
    ...
    [Migration("20230618211521_IncludeIdentityAddress")]
    partial class IncludeIdentityAddress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelManagementSystem.Areas.Management.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("HotelManagementSystem.Areas.Management.Models.ProductCategory", b =>
                {
                    b.Property<int>("ProductCategoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelManagementSystem.Areas.Public.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ImageURL = "Wallgate Apartments",
                            NewsDate = new DateTime(2023, 6, 18, 22, 15, 20, 654, DateTimeKind.Local).AddTicks(4377),
                            Title = "something"
                        },
                        new
                        {
                            ID = 2,
                            ImageURL = "Wallgate Apartments",
                            NewsDate = new DateTime(2023, 6, 18, 22, 15, 20, 654, DateTimeKind.Local).AddTicks(4392),
                            Title = "something"
                        },
                        new
                        {
                            ID = 3,
                            ImageURL = "Wallgate Apartments",
                            NewsDate = new DateTime(2023, 6, 18, 22, 15, 20, 654, DateTimeKind.Local).AddTicks(4395),
                            Title = "something"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "5311985b-1e7e-4597-844f-7473ca7a557d",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "bf3e6e61-2fba-4579-a91e-8806129a55a2",
                            Name = "Manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "2010d5cb-2d96-4897-a008-765216ef79c4",
                            Name = "Receptionist",
                            NormalizedName = "RECEPTIONIST"
                        },
                        new
                        {
                            Id = "8c0114d0-8289-4d3c-b314-d404ab2d7add",
                            Name = "Waiter",
            ...
            modelBuilder.Entity("HotelManagementSystem.Areas.Management.Models.Product", b =>
                {
                    b.HasOne("HotelManagementSystem.Areas.Management.Models.ProductCategory", null)
                        .WithMany("Products")
            ...
            modelBuilder.Entity("HotelManagementSystem.Areas.Management.Models.Sale", b =>
                {
                    b.HasOne("HotelManagementSystem.Areas.Management.Models.Product", "Product")
                        .WithMany("Sales")
