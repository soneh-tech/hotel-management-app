...
namespace HotelManagementSystem.Data.Migrations
{
    ...
    [Migration("20230615174521_RestrictDelete")]
            ...
            modelBuilder.Entity("HotelManagementSystem.Areas.Public.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ImageURL = "Wallgate Apartments",
                            NewsDate = new DateTime(2023, 6, 15, 18, 45, 20, 314, DateTimeKind.Local).AddTicks(6466),
                            Title = "something"
                        },
                        new
                        {
                            ID = 2,
                            ImageURL = "Wallgate Apartments",
                            NewsDate = new DateTime(2023, 6, 15, 18, 45, 20, 314, DateTimeKind.Local).AddTicks(6494),
                            Title = "something"
                        },
                        new
                        {
                            ID = 3,
                            ImageURL = "Wallgate Apartments",
                            NewsDate = new DateTime(2023, 6, 15, 18, 45, 20, 314, DateTimeKind.Local).AddTicks(6497),
                            Title = "something"
                        });
                });
