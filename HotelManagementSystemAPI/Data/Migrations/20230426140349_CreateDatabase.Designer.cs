...
namespace HotelManagementSystemAPI.Data.Migrations
{
    ...
    [Migration("20230426140349_CreateDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AmmenityRoomType", b =>
                {
                    b.HasOne("HotelManagementSystemAPI.Models.Ammenity", null)
                        .WithMany()
                        .HasForeignKey("AmmenitiesAmmenityID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HotelManagementSystemAPI.Models.RoomType", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HotelManagementSystemAPI.Models.Booking", b =>
                {
                    ...
                    b.HasOne("HotelManagementSystemAPI.Models.Room", null)
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("HotelManagementSystemAPI.Models.Employee", b =>
                {
                    b.HasOne("HotelManagementSystemAPI.Models.Designation", null)
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("HotelManagementSystemAPI.Models.Item", b =>
                {
                    b.HasOne("HotelManagementSystemAPI.Models.ItemCategory", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("HotelManagementSystemAPI.Models.Payment", b =>
                {
                    ...
                    b.HasOne("HotelManagementSystemAPI.Models.Customer", null)
                        .WithMany("Payments")
                        .HasForeignKey("CustomerID");
                });
            ...
            modelBuilder.Entity("HotelManagementSystemAPI.Models.Sale", b =>
                {
                    ...
                    b.HasOne("HotelManagementSystemAPI.Models.Employee", null)
                        .WithMany("Sales")
                        .HasForeignKey("EmployeeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HotelManagementSystemAPI.Models.Item", null)
                        .WithMany("Sales")
